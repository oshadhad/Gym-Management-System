...
export default function EditMaintenance({
    ...
    const { data, setData, patch, errors } = useForm<MaintenanceData>({
        machine_id: maintenances.machine_id || "",
        title: maintenances.title || "",
        description: maintenances.description || "",
        startDate: maintenances.startDate || "",
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        patch(route("ag.maintenances.update", maintenances.id));
    };
    ...
    const bRoutes = [
        ...
        },
        {
            name: "Edit",
            hasArrow: true,
            link: route("ag.maintenances.edit", maintenances.id),
        },
    ];
    console.log(maintenances)

    return (
        <AgentLayout bRoutes={bRoutes} title={"Edit Maintenance"}>
            <div className="py-8">
